...
var ProjectTaskListComponent = (function () {
    function ProjectTaskListComponent(service, route, router) {
        this.service = service;
        this.route = route;
        this.router = router;
    }
    ProjectTaskListComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    return ProjectTaskListComponent;
}());
exports.ProjectTaskListComponent = ProjectTaskListComponent;
/*
Copyright 2016 Google Inc. All Rights Reserved.
Use of this source code is governed by an MIT-style license that
can be found in the LICENSE file at http://angular.io/license
*/ 
//# sourceMappingURL=project-task-list.component.js.map