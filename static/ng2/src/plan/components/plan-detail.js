...
var HeroDetailComponent = (function () {
    ...
    HeroDetailComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.route.params.subscribe(function (params) {
            ...
            _this.service.getPlan(id).then(function (hero) { return _this.hero = hero; });
        });
    };
    ...
    HeroDetailComponent = __decorate([
        ...
        __metadata('design:paramtypes', [router_1.ActivatedRoute, router_1.Router, plan_1.PlanService])
    ], HeroDetailComponent);
...
*/ 
//# sourceMappingURL=plan-detail.js.map